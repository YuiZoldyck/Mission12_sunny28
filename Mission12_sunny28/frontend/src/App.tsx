...
class Heading extends React.Component {
  render() {
    return (
      <h1>This website lists out information about all colleges participating in NCAA Basketball.</h1>
    );
  }
}
  ...
  render() {
    ...
    if (oneSchool.name != ""){
      ...
      <div style={{border: "1px solid #000" }}>
        <h3>{oneSchool.school}</h3>
        <h5>{oneSchool.name}</h5>
        <h5>{oneSchool.city}, {oneSchool.state}</h5><br/>
      </div>
    );
    } else {
      return(
...
function TeamList() {
  return (
    <div style={{columns: "2"}}>
      {basketball.teams.map(oneSchool => <Card {...oneSchool}/>)}
    </div>
  );
}
function App() {
